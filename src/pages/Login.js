...
const Login = () => {
  ...
  useEffect(() => {
    if (isLoggedIn) {
      if (localStorage.getItem("futr_role") === "Parent") {
        ...
        navigate("/dashboard");
      } else if (localStorage.getItem("futr_role") === "Teacher") {
        // navigate("/teacher-dashboard");
        navigate("/dashboard");
      } else if (localStorage.getItem("futr_role") === "Student") {
        // navigate("/my-profile");
        navigate("/dashboard");
      } else if (localStorage.getItem("futr_role") === "School") {
        navigate("/dashboard");
      } else {
        navigate("/my-profile");
      }
  ...
  const handleLogin = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      // console.log(data);
      dispatch(asyncLogin(data, navigate, initialState));
    }
      ...
      <div className="login_bg_main">
        <div className="container">
          <div className="row login_container">
            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7 dis_mobile">
